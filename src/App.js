...
function App() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Check if we've reached the Important Dates section
      const importantDatesSection = document.getElementById('dates-registration');
      let hideMainNav = false;
      
      if (importantDatesSection) {
        const sectionTop = importantDatesSection.offsetTop;
        if (scrollTop >= sectionTop - 100) { // Hide when close to Important Dates section
          hideMainNav = true;
        }
      }

      // Handle sticky navigation with improved logic
      if ((scrollTop >= triggerPoint && subNavOriginalTop !== null) || hideMainNav) {
        // When we reach the sub-nav or Important Dates, make sub-nav stick to top and hide main nav
    ...
    <div className="App">
      ...
      <nav className="fixed-nav">
        <div className="nav-container">
          <div className="logo">
            ...
            />
            <a 
              href="https://jaipur.manipal.edu/index.php" 
              target="_blank" 
          ...
          <div className="nav-links">
            <a href="#organisers-section" onClick={(e) => { e.preventDefault(); setCurrentPage('home'); document.getElementById('organisers-section')?.scrollIntoView({ behavior: 'smooth' }); }}>
              <ScrambleText 
            ...
            <a href="#sponsors" onClick={(e) => { e.preventDefault(); setCurrentPage('home'); document.getElementById('sponsors')?.scrollIntoView({ behavior: 'smooth' }); }}>
              <ScrambleText 
                text="Sponsors"
                className="main-nav-scramble"
                scrambleChars="ABCDEFGHIJKLMNOPQRSTUVWXYZ!@#$%^&*"
            ...
            <button 
              ...
              onClick={() => document.getElementById('dates-registration')?.scrollIntoView({ behavior: 'smooth' })}
              style={{
                backgroundColor: 'black',
                border: '2px solid #f8dd93',
                color: '#f8dd93',
                padding: '8px 16px',
                borderRadius: '4px',
                fontSize: '14px',
              ...
              onMouseEnter={(e) => {
                e.target.style.backgroundColor = '#f8dd93';
                e.target.style.color = 'black';
              }}
              onMouseLeave={(e) => {
                e.target.style.backgroundColor = 'black';
                e.target.style.color = '#f8dd93';
              }}
            >
              Register Now
            </button>
      ...
      <main className="main-content">
        <div className="page-container">
          ...
          <section id="organisers-section" className="content-section">
            <h2>Conference Organisers</h2>
            <p>Meet the organizing committee behind TrustNet 2026.</p>
      ...
      {/* Advanced Footer */}
      <footer className="advanced-footer" style={{marginTop: '20px'}}>
        ...
        <div className="footer-content-wrapper">
          <div className="footer-main-content">
            ...
            <div className="footer-brand-section">
              ...
              <div className="footer-title-section">
                ...
                <div className="footer-conference-details">
                  <span className="footer-date">FEB 6-7, 2026</span>
            ...
            <div className="footer-nav-section" style={{paddingTop: '60px'}}>
              <div className="footer-nav-column">
                ...
                <div className="footer-nav-links">
                  ...
                  <a href="#organisers-section" className="footer-nav-link" onClick={(e) => { e.preventDefault(); setCurrentPage('home'); setTimeout(() => document.getElementById('organisers-section')?.scrollIntoView({ behavior: 'smooth' }), 100); }}>Organisers</a>
              ...
              <div className="footer-nav-column">
                ...
                <div className="footer-nav-links">
                  ...
                  <a href="#organisers-section" className="footer-nav-link" onClick={(e) => { e.preventDefault(); setCurrentPage('home'); setTimeout(() => document.getElementById('organisers-section')?.scrollIntoView({ behavior: 'smooth' }), 100); }}>Organisers</a>
                  <a href="#sponsors" className="footer-nav-link">Sponsors</a>
                </div>
              </div>
